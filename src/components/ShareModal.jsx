        ...
        {!showQR && (
          <div className="share-link-wrapper">
            ...
            <button 
              ...
              onClick={handleCopy}
              aria-label={copied ? t('share.modal.copied') : t('share.modal.copy_button')}
            >
        ...
        <div className="share-social">
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M20.665 3.717l-17.73 6.837c-1.21.486-1.203 1.161-.222 1.462l4.552 1.42 10.532-6.645c.498-.303.953-.14.578.192l-8.533 7.701h-.002l.002.001-.314 4.692c.46 0 .663-.211.921-.46l2.211-2.15 4.599 3.397c.848.467 1.457.227 1.668-.786l3.023-14.24c.31-1.242-.475-1.807-1.285-1.421z" fill="white"/>
            </svg>
          </a>
          ...
          <button 
            ...
            onClick={() => window.location.href = `mailto:?subject=${encodeURIComponent(projectTitle)}&body=${encodeURIComponent(shareUrl)}`}
