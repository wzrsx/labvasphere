            ...
            >
              ...
              <div className="modal-body">
                ...
                <p className="warning-text">
                  {t('modal.publish_before_share.warning')}
                </p>
              </div>
                        ...
                        <div className="stats-row">
                          <div className="stat-block">
                            ...
                            >
                              ...
                              >
                                <path
                                  d="M2569 4858 c-184 -65 -264 -178 -298 -423 -51 -360 -151 -696 -268
...
405 0 405 0 0 -1090z"
                          ...
                          <div className="stat-block">
                            ...
                            >
                              ...
                              >
                                <path
                                  d="M1072 5100 c-189 -50 -346 -199 -404 -383 l-23 -72 0 -2185 0 -2185
...
1440 21 1381 0 1395 -1 1440 -21z"
                                />
                                <path
                                  d="M1914 4039 c-91 -11 -141 -26 -229 -69 -333 -161 -489 -575 -355
...
69 23 147 20 75 -2 100 -8 150 -31z"
                  ...
                  >
                    {project.showStats
                      ? t('projects.toggle.description')
                      : t('projects.toggle.stats')}
                  </button>
                      ...
                      <span className="button-icon">
                        ...
                        >
                          <g clip-path="url(#clip0_403_3667)">
                            <path
                              d="M18.9649 8.46398L23.9939 3.43498L22.5649 2.00598L17.5189 7.05098L15.3129 4.89498C14.9509 4.54313 14.4698 4.3403 13.9651 4.32678C13.4605 4.31325 12.9692 4.49002 12.5889 4.82198C10.7327 6.50283 8.57316 7.81456 6.2259 8.68698L-0.00610352 10.514V11.27C0.0350478 14.6829 1.42795 17.9403 3.86717 20.3278C6.3064 22.7152 9.59285 24.038 13.0059 24.006H14.2469L14.5079 23.824C16.5468 22.5169 18.2383 20.735 19.4376 18.6309C20.6369 16.5268 21.3082 14.1633 21.3939 11.743C21.4015 11.4643 21.3511 11.187 21.2459 10.9288C21.1407 10.6706 20.9831 10.4371 20.7829 10.243L18.9649 8.46398ZM13.8999 6.33998L19.3769 11.681C19.347 12.7007 19.1939 13.713 18.9209 14.696L11.9409 7.89998C12.6199 7.41345 13.2737 6.89278 13.8999 6.33998ZM13.6059 21.985H13.0059C11.5322 21.9851 10.0731 21.6931 8.7129 21.126C10.4606 20.2479 11.9567 18.9404 13.0609 17.326L13.5789 16.566L11.9099 15.43L11.3919 16.191C10.479 17.5224 9.24305 18.6004 7.7999 19.324L6.5709 19.942C5.57165 19.2386 4.6978 18.3722 3.9859 17.379C5.617 16.8267 7.10514 15.9192 8.3429 14.722L6.9319 13.277C5.81432 14.3596 4.45059 15.1547 2.9579 15.594C2.44016 14.4668 2.12824 13.256 2.0369 12.019L6.7919 10.625C7.99439 10.2389 9.14422 9.70482 10.2149 9.03498L18.1259 16.735C17.0798 18.8334 15.527 20.6379 13.6079 21.985H13.6059Z"
                              fill="currentColor"
                            />
                          </g>
                          <defs>
